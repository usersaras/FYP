...
if(!isset($_POST['submit'])){
    ...
    $check_sql = "SELECT * FROM BOOKING WHERE FK_CUSTOMERID=$userid";
    ...
    $fac_sql = "SELECT * FROM FACILITY WHERE FACILITY_NAME='$facility' AND FACILITY_STATUS='Available' LIMIT 1";
