...
?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
                ...
                <div class="card-body">
                  <form>
                    <input type="text" name="hospitalname" class="form-control" placeholder="Add hospital's name" />
                     <select id="country" name='country' onchange="random_function()"  class="form-control dashboard-form-padding">
        ...
        <div id="my-frm">
        <select id="output" name="dist" onchange="random_function2()" class="form-control dashboard-form-padding">
            <option>Select</option>
        </select>
        </div>

        <select id="outputw" name="a" class="form-control dashboard-form-padding">
            <option>Select</option>
        </select>
