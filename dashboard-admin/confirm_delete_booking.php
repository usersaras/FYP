...
?>
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">The booking with following details will be deleted</p>


        <div class="alert alert-danger">Are you sure you want to delete this booking? If yes, <a href='config/delete_booking.php?id=<?php echo $bookingid ?>'><button class="btn btn-danger">click here.</button></a></div>
...
<div class="alert alert-danger">Are you sure you want to delete this booking? If yes, <a href='config/delete_booking.php'><button class="btn btn-danger">click here.</button></a></div>
<!-- DataTales Example -->
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-success">Booking Details</h6>
