        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">List of patients hospitalized through bed finder.</h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="individual_patients.php?id=<?php echo $value['CUSTOMER_ID']; ?>" class="btn btn-primary">View Details</a></td>
                    </tr>
