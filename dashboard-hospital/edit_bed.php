...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Hospital Bed</h1>
          </div>
            ...
            <div class="col-lg-8 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-info">Edit Form</h6>
                </div>
                <div class="card-body">
                <form method="POST" action="config/edit_hospital_bed.php?id=<?php echo $bedid ?>">
                  ...
                  <input type="text" placeholder="Update bed's price" class="form-control" name="charge" value="<?php echo $value['BED_PRICE'] ?>"/>

                  <select class="form-control" name="bed_status" >
                      <option> 
                      <?php
                     echo $value['BED_STATUS']; 
                       ?>
                       </option>
