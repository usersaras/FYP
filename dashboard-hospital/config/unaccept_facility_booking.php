...
$booking_sql = "UPDATE BOOKING SET BOOKING_STATUS='Booked' WHERE BOOKING_ID=$bookingid";
$facility_sql = "UPDATE FACILITY SET FACILITY_STATUS='Booked' WHERE FACILITY_ID=$facilityid";
$bed_sql = "UPDATE BED SET BED_STATUS='Booked' WHERE BED_ID=$bedid";
...
echo "<script>alert('Booking unaccepted!')</script>";
echo "<script>window.location='../accept_patient_bookings.php'</script>";
